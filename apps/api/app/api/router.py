...
from app.api.routes import analysis, auth, billing, compare, contacts, health, imports, qa, reply_coach, vault
...
api_router.include_router(compare.router, prefix="/contacts", tags=["compare"])
...
api_router.include_router(billing.router, prefix="/contacts", tags=["billing"])
